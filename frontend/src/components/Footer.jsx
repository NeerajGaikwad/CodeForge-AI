...
const Footer = () => {
    ...
    const footerSections = [
        ...
        },
        {
            title: 'Support',
            items: [
                { label: 'Documentation', action: () => window.open('https://github.com/YOUR_GITHUB_USERNAME/CodeForge-AI', '_blank') },
                {
                    label: 'Contact', action: () => {
                        window.open('https://mail.google.com/mail/?view=cm&fs=1&to=support@example.com', '_blank')
                        navigator.clipboard.writeText('support@example.com')
                        toast.success('Email copied: support@example.com')
                    }
                },
        ...
        <footer className='bg-slate-900 border-t border-slate-800'>
                    ...
                    <div className='hidden md:block md:w-2/5 bg-gradient-to-br from-blue-900 via-slate-800 to-slate-900 relative overflow-hidden'>
                        <div className='absolute inset-0 flex items-center justify-center'>
                            <div className='text-center px-8'>
                                ...
                                <p className='text-slate-500 text-xs mt-1'>Join 1000+ developers on CodeForge AI</p>
                            </div>
                        </div>
                        {/* decorative circles */}
            ...
            <div className='max-w-6xl mx-auto px-5 sm:px-6 md:px-10 pb-10'>
                <div className='grid grid-cols-2 md:grid-cols-5 gap-6 md:gap-8 pb-8 md:pb-10 border-b border-slate-800'>
                    ...
                    <div className='col-span-2 md:col-span-1 text-center md:text-left'>
                        <div className='flex items-center justify-center md:justify-start gap-2 mb-4'>
                            ...
                            <span className="font-bold bg-gradient-to-b from-[#ff7a00] to-[#ffd500] bg-clip-text text-transparent">CodeForge-AI</span>
                        </div>
                        ...
                        <div className='flex justify-center md:justify-start gap-3'>
                            {[
                                { icon: 'ri-github-line', href: 'https://github.com/YOUR_GITHUB_USERNAME/CodeForge-AI', color: 'bg-[#24292f] hover:bg-[#181717] ' },
                                { icon: 'ri-twitter-x-line', href: 'https://x.com/YOUR_X_USERNAME', color: 'bg-black hover:bg-zinc-800' },
                                { icon: 'ri-linkedin-line', href: 'https://www.linkedin.com/in/YOUR_LINKEDIN_USERNAME/', color: 'bg-[#0A66C2] hover:bg-[#004182]' },
                            ].map((s, i) => (
                ...
                <div className='pt-6 flex flex-col md:flex-row items-center justify-center md:justify-between gap-3 text-center'>
                    <p className='text-xs text-slate-500'>© 2026 CodeForge-AI. All rights reserved.</p>
                    <p className='text-xs text-slate-600'>Built with ❤️ by <span className='text-slate-400'>Neeraj Gaikwad</span></p>
                </div>
            </div>
