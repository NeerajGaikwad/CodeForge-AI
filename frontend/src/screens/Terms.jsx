            ...
            <div className='max-w-3xl mx-auto'>
                ...
                <div className='space-y-8 text-sm text-slate-400 leading-relaxed'>
                    <section>
                        ...
                        <p>By accessing or using CodeForge-AI, you agree to be bound by these Terms of Service. If you do not agree, please do not use the platform.</p>
                    </section>

                    <section>
                        <h2 className='text-lg font-semibold text-white mb-2'>2. Use of the Platform</h2>
                        <p>CodeForge-AI provides a collaborative coding environment with AI assistance powered by Google Gemini. You agree to use the platform only for lawful purposes and not to misuse, disrupt, or attempt unauthorized access to any part of the service.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>You retain ownership of code and content you create on CodeForge AI. By using collaboration features, you grant collaborators you invite the ability to view and edit your project content.</p>
                    </section>

                    <section>
                        <h2 className='text-lg font-semibold text-white mb-2'>5. AI-Generated Content</h2>
                        <p>AI responses are generated automatically and may contain errors. CodeForge-AI does not guarantee the accuracy, security, or fitness of AI-generated code for any particular purpose. Review all AI suggestions before use.</p>
                    </section>

                    <section>
                        <h2 className='text-lg font-semibold text-white mb-2'>6. Service Availability</h2>
                        <p>CodeForge AI is provided "as is" without warranties of any kind. We do not guarantee uninterrupted or error-free operation of the platform.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>We may update these Terms from time to time. Continued use of CodeForge AI after changes constitutes acceptance of the revised terms.</p>
                    </section>

                    <section>
                        <h2 className='text-lg font-semibold text-white mb-2'>9. Contact</h2>
                        <p>For questions about these Terms, contact us at <a href="mailto:support@example.com" className='text-blue-400 hover:underline'>support@example.com</a>.</p>
                    </section>
                </div>
            </div>
        </main>
