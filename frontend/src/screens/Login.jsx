...
const Login = () => {
    ...
    function demoLoginHandler() {
        ...
        axios.post(
            `${apiUrl}/users/demo-login`
        )
            .then((res) => {

                toast.success(
                    "Welcome to CodeForge AI Demo!"
                );
                        ...
                        <>
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="w-full rounded-2xl border border-blue-500/50 bg-blue-500/10 px-5 py-3 text-sm font-semibold text-blue-300 transition hover:bg-blue-500/20 hover:border-blue-400 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
