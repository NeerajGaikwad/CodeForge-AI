        ...
        <div className="min-h-screen bg-slate-900 text-white font-sans">
            ...
            <section id='home' className="px-6 md:px-16 pt-24 pb-20 text-center max-w-4xl mx-auto">
                ...
                <p className="text-slate-400 text-lg md:text-xl leading-relaxed mb-10 max-w-2xl mx-auto">
                    CodeForge AI is a collaborative coding platform where your team and Gemini AI work in the same room — real-time editor, in-browser terminal, and persistent chat.
                </p>
            ...
            <section className="px-6 md:px-16 pb-24">
                <div className="max-w-5xl mx-auto rounded-2xl overflow-hidden border border-slate-700 bg-slate-800 shadow-2xl">
                    <div className="flex items-center gap-2 px-4 py-3 bg-slate-900 border-b border-slate-700">
                        ...
                        <div className="flex-1 mx-4 bg-slate-800 rounded-md px-3 py-1 text-xs text-slate-500 text-center">localhost:5173</div>
                    </div>
            ...
            <section id='about-section' className="px-6 md:px-16 py-20 border-t border-slate-800">
                <div className="max-w-5xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div>
                            <p className="text-xs text-blue-400 uppercase tracking-widest font-medium mb-3">About CodeForge AI</p>
                            <h2 className="text-3xl md:text-4xl font-bold mb-4">Code together, ship faster</h2>
                            <p className="text-slate-400 text-sm leading-relaxed mb-4">
                                CodeForge AI is a collaborative coding platform where your team and Gemini AI work in the same room — real-time editor, in-browser terminal, and persistent chat.
                            </p>
                            <p className="text-slate-400 text-sm leading-relaxed mb-6">
                                Built with React, Node.js, Socket.io, Redis, WebContainers API, and Google Gemini — CodeForge AI is designed for speed, collaboration, and developer joy.
                            </p>
                    ...
                    <div className="mt-12 pt-10 border-t border-slate-800 text-center">
                        ...
                        <p className="text-slate-400 text-sm leading-relaxed mb-5 max-w-xl mx-auto">
                            CodeForge AI was created and is maintained by{' '}
                            <span className="text-white font-semibold">Neeraj Gaikwad</span>,
                            a B.E. Information Technology student, passionate about building innovative developer tools, AI-powered applications, and collaborative technology platforms.
                        </p>
                        <div className="flex flex-wrap items-center justify-center gap-2 md:gap-3">
                            <a href="https://github.com/YOUR_GITHUB_USERNAME" target="_blank" rel="noreferrer"
                                ...
                                <i className="ri-github-line text-base leading-none"></i><span>YOUR_GITHUB_USERNAME</span>
                            </a>
                            <a href="https://www.linkedin.com/in/YOUR_LINKEDIN_USERNAME/" target="_blank" rel="noreferrer"
                                className="inline-flex items-center gap-1.5 text-sm text-slate-400 hover:text-white transition px-3 py-1.5 rounded-lg hover:bg-slate-800">
                                <i className="ri-linkedin-line text-base leading-none"></i><span>YOUR_LINKEDIN_USERNAME</span>
                            </a>
                            <a href="https://x.com/YOUR_X_USERNAME" target="_blank" rel="noreferrer"
                                className="inline-flex items-center gap-1.5 text-sm text-slate-400 hover:text-white transition px-3 py-1.5 rounded-lg hover:bg-slate-800">
                                <i className="ri-twitter-x-line text-base leading-none"></i><span>YOUR_X_USERNAME</span>
                            </a>
                            <a href="https://www.instagram.com/YOUR_INSTAGRAM_USERNAME/" target="_blank" rel="noreferrer"
                                className="inline-flex items-center gap-1.5 text-sm text-slate-400 hover:text-white transition px-3 py-1.5 rounded-lg hover:bg-slate-800">
                                <i className="ri-instagram-line text-base leading-none"></i><span>YOUR_INSTAGRAM_USERNAME</span>
                            </a>
                        </div>
                    </div>
                </div>
