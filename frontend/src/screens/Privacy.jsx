            ...
            <div className='max-w-3xl mx-auto'>
                ...
                <div className='space-y-8 text-sm text-slate-400 leading-relaxed'>
                    ...
                    <section>
                        ...
                        <p>We use your information to provide and improve CodeForge-AI's services, authenticate your account via OTP, enable collaboration features, and communicate updates if you subscribe to our newsletter.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>CodeForge-AI uses third-party services including Google Gemini (AI), Resend (email delivery), and WebContainers (in-browser code execution). These services have their own privacy policies governing data they process.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>You may request access to, correction of, or deletion of your personal data by contacting us at <a href="mailto:support@example.com" className='text-blue-400 hover:underline'>support@example.com</a>.</p>
                    </section>
